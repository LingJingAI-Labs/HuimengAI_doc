...
欢迎您使用"绘梦AI"付费服务，请您仔细阅读、理解并遵守如下协议。

《"绘梦AI"付费服务协议》（以下称"本协议"）适用于绘梦AI付费服务及相关功能（以下称"绘梦AI付费服务"、"付费服务"或"本服务"）。

为使用绘梦AI付费服务及相关功能，您应当阅读并遵守《"绘梦AI"付费服务协议》（以下简称"本协议"）、《"绘梦AI"用户服务协议》、《"绘梦AI"隐私政策》、绘梦AI创作功能相关使用须知等协议及规则（以下统称"服务协议及规则"）。本协议为《"绘梦AI"用户服务协议》、《"绘梦AI"隐私政策》的补充协议，是其不可分割的组成部分，与其构成统一整体，本协议与上述协议存在冲突或不一致的，以本协议为准。
...
1. 本协议适用于"绘梦AI"用户在绘梦AI平台及我们合作平台购买绘梦AI功能下的各项付费服务。目前我们提供的付费服务包括"积分包"购买服务和其他付费服务等各项付费服务（以实际购买时的产品页面规则说明及服务权益实际展示为准）。您购买、使用以上任一项或多项付费服务，均将适用本协议。

2. 我们已经发布、后续可能发布的、不时修改的与"绘梦AI"有关的其他全部相关协议、活动规则、公告、说明、站内信通知等（合称"平台规则"）均属于本协议不可分割的组成部分，与本协议具有同等法律效力。

### （二）定义

1. **"绘梦AI"/"绘梦AI"平台**：即是指由公司合法拥有或有权运营"绘梦AI"品牌，包括但不限于绘梦AI网站([https://huimengai.lingjingai.cn/](https://huimengai.lingjingai.cn/))、"绘梦AI"移动应用程序、"绘梦AI"小程序，以及供第三方网站和应用程序使用的"绘梦AI"相关软件开发工具包（SDK）和应用程序编程接口（API）等现有以及后续可能开通的其他网站、网页、客户端、小程序和随技术发展出现的新的服务载体（以下或称"平台"）。公司有权根据业务发展、安排随时调整向您提供的具体"绘梦AI"软件版本，请以您实际下载使用的版本为准。

2. **"灵境万维"**：指注册地址位于杭州的灵境万维（杭州）智能科技有限公司。以下称"灵境万维"、"公司"或"我们"。

3. **"绘梦AI"付费服务**：即"绘梦AI"平台基于"绘梦AI"产品向您提供的通过支付一定费用购买积分包，享用相应"绘梦AI"产品权益的服务。您支付费用后，可在相应服务期限内，持续体验"绘梦AI"平台指定范围内的付费权益，以下称"绘梦AI付费服务"、或"本服务"。提示您注意，不同"绘梦AI"产品形态提供及支持的付费服务可能不同，请您在开通对应服务时仔细了解产品界面相关信息。

4. **"本协议"**：灵境万维（杭州）智能科技有限公司及/或其关联方与您（以下或称"用户"）之间，就您使用"绘梦AI"付费服务相关事宜与您达成《"绘梦AI"付费服务协议》，以下称"本协议"。

5. **"用户"**：指登录、使用"绘梦AI"并拟开通付费服务的"绘梦AI"用户，以下称"用户"、"您"。

6. **"积分包服务"**：指绘梦AI平台为您提供的不同版本的积分包服务，包括体验版、入门版、专业版、企业版，积分包服务权益说明请您查看本协议第三条，具体权益内容以您实际购买时的产品界面公示及服务权益实际展示为准。

7. **"积分"**：是我们向用户提供的用于在"绘梦AI"及我们合作平台内进行相关消费的虚拟工具，您可以使用"积分"兑换"绘梦AI"平台上的特定功能（以下称"积分服务"）。为免疑义，积分服务是平台向用户提供的网络技术及相关服务，积分服务并非网络支付服务，积分也不是代币票券、虚拟货币或预付款凭证，不具备货币价值、预付价值。具体权益内容以您实际购买时的产品界面公示及服务权益实际展示为准。

8. **"单独付费服务"**：是指除积分包服务外，"绘梦AI"平台就某些特定功能开通的单独付费服务。具体权益内容以您实际购买时的产品界面公示及服务权益实际展示为准。

9. **"用户账号"**：是指用户自己注册、登录并使用的绘梦AI的账号。用户可以使用"用户账号"开通、购买一项或多项的"绘梦AI"付费服务。
...
13. **"平台规则"**：指本协议、《"绘梦AI"用户服务协议》、《"绘梦AI"隐私政策》，及公司已经或在未来不时发布的"绘梦AI"相关服务、单项/多项付费服务的协议、规则等协议和内容的统称。上述内容一经正式发布即生效，为本协议不可分割的组成部分。

## 二、付费服务的开通及使用

1. 您须先注册或登录"绘梦AI"，完成账号认证后，方能继续进行本服务的购买、使用。

2. 绘梦AI功能的各项付费服务适用不同的付费模式，包括但不限于（1）绘梦AI积分包服务；（2）购买"积分"兑换特定AI功能；（3）特定功能的单独付费等。请您仔细阅读本协议、实际购买时的产品界面公示及服务权益实际展示页面中您拟购买的具体付费服务的相关使用规则。公司可能会依据不同营销策略及产品具体情况调整付费模式，实际应以前端产品功能展示的付费模式为准。
...
1. "积分"是我们向用户提供的用于在"绘梦AI"及我们合作平台内兑换相关功能的虚拟工具，您可以使用积分兑换"绘梦AI"上的特定功能（具体请查看"绘梦AI"相关服务页面的提示说明）。

2. 为避免产生疑义，积分服务是平台向用户提供的网络技术及相关服务，积分服务并非网络支付服务，积分也不是代币票券、虚拟货币或预付款凭证，不具备货币价值、预付价值。

3. 积分只能被用于兑换本协议约定的"绘梦AI"产品或服务，积分不支持被反向兑换为人民币及其他货币。
...
8. 您可在["绘梦AI"网站顶部导航栏]-[积分详情]或["绘梦AI"APP首页右上角]-[积分详情]查看积分的余额情况、剩余有效期、积分获取和消耗等记录，该记录将作为您使用积分情况的有效依据。如您对积分记录有异议，您可以通过本协议约定的联系方式与公司联系，我们调查核对后确有错误的，将予以更正。
...
1. 您可以通过绘梦AI平台支持的多种支付方式进行付费，包括但不限于微信支付、支付宝、银行卡支付等。具体支持的支付方式以实际购买页面展示为准。
...
1. 绘梦AI平台及相关服务的知识产权归灵境万维（杭州）智能科技有限公司所有。

2. 您使用付费服务生成的内容，其知识产权归属按照《绘梦AI用户服务协议》的相关约定执行。

3. 未经我们书面同意，您不得擅自使用绘梦AI的商标、标识等知识产权。
